<?php 
    ...
    if(isset($_POST['submit']))
    {
	                ...
	                $_SESSION['pass']=$_POST['pass1'];
	 				header("Location:http://localhost/library%20management/bd.php");
	 }              
...
<!-- <script>
	function validations(){
		var rxd1=document.getElementById("rd1");
		var rxd2=document.getElementById("rd2");
		if(rxd1.checked==true){
			//document.getElementById("frm1").action="staff.html";
			document.f1.action="staff.html";
			return true;
		}
		else(rxd2.checked==true){
			//document.getElementById("frm1").action="student.html";
			document.f1.action="student.html";
			return true;
		}
		else if(rxd1.checked==false && rxd2.checked==false){
			alert('please select who you are student or staff');
			return false;
		}
	}
